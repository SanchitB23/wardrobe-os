  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="Estimated price" htmlFor="price">
        ...
        <Field label="Material / fabric" htmlFor="material">
      ...
      <Field label="Style tags (comma-separated)" htmlFor="styleTags">
        <Input id="styleTags" value={form.styleTags} onChange={(e) => set("styleTags")(e.target.value)} placeholder="Smart casual, Minimal" />
      </Field>
      <Field label="Intended occasions (comma-separated)" htmlFor="occasions">
