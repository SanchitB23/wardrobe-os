...
export { OUTFIT_SLOT_DEFINITIONS, categoryMatchesOutfitSlot } from "@/domain/outfit/slot-matching";
...
export { calculateCostPerWear } from "@/domain/wardrobe/cost-per-wear";
